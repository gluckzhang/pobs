...
def workload_generator(duration):
    ...
    correct_response = '{"hints":{"visited_nodes.sum":78,"visited_nodes.average":78.0},"info":{"copyrights":["GraphHopper","OpenStreetMap contributors"],"took":1},"paths":[{"distance":6197.582,"weight":536.019699,"time":535952,"transfers":0,"snapped_waypoints":"m}c`IutfpA~zBwvK"}]}'
...
def main():
    ...
    container_name = "graphhopper-pobs-strace-only"
